...
func newRootCmd(flags *rootFlags) *cobra.Command {
	rootCmd := &cobra.Command{
		Use:   "wahoo-pp-cli",
		Short: `Wahoo CLI — Every Wahoo Cloud API capability, plus the local training database and offline analysis Wahoo's app never gives you.`,
		Long: `Wahoo CLI — Every Wahoo Cloud API capability, plus the local training database and offline analysis Wahoo's app never gives you.
...
Health check: run 'wahoo-pp-cli doctor' to verify auth and connectivity.
See README.md or the bundled SKILL.md for recipes.`,
		SilenceUsage: true,
		Version:      version,
	}
	rootCmd.SetVersionTemplate("wahoo-pp-cli {{ .Version }}\n")
	...
	rootCmd.PersistentFlags().StringVar(&flags.profileName, "profile", "", "Apply values from a saved profile (see 'wahoo-pp-cli profile list')")
	...
	rootCmd.AddCommand(newPowerZonesCmd(flags))
	rootCmd.AddCommand(newRoutesCmd(flags))
	rootCmd.AddCommand(newUserCmd(flags))
	rootCmd.AddCommand(newWorkoutFileUploadsCmd(flags))
	...
	rootCmd.AddCommand(newNovelBackupCmd(flags))
	rootCmd.AddCommand(newNovelBestsCmd(flags))
	rootCmd.AddCommand(newNovelDigestCmd(flags))
	rootCmd.AddCommand(newNovelFtpHistoryCmd(flags))
	rootCmd.AddCommand(newNovelLoadCmd(flags))
