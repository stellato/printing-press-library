...
func newRootCmd(flags *rootFlags) *cobra.Command {
	rootCmd := &cobra.Command{
		Use:   "ikon-pp-cli",
		Short: `Ikon Pass CLI for reservation availability, pass and voucher lookup, usage history, and change tracking.`,
		Long: `Ikon Pass CLI for reservation availability, pass and voucher lookup, multi-season usage history, and offline change tracking.
...
Health check: run 'ikon-pp-cli doctor' to verify auth and connectivity.
See README.md or the bundled SKILL.md for recipes.`,
		SilenceUsage: true,
		Version:      version,
	}
	rootCmd.SetVersionTemplate("ikon-pp-cli {{ .Version }}\n")
	...
	rootCmd.PersistentFlags().StringVar(&flags.profileName, "profile", "", "Apply values from a saved profile (see 'ikon-pp-cli profile list')")
	...
	rootCmd.AddCommand(newNovelMostVisitedCmd(flags))
	...
	rootCmd.AddCommand(newBenefitsPromotedCmd(flags))
	rootCmd.AddCommand(newPassesPromotedCmd(flags))
	rootCmd.AddCommand(newReservationsPromotedCmd(flags))
	rootCmd.AddCommand(newResortsPromotedCmd(flags))
