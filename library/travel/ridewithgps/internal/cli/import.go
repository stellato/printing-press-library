...
but do not stop the import.`,
  ...
  ridewithgps-pp-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  ridewithgps-pp-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | ridewithgps-pp-cli import <resource> --input -`,
