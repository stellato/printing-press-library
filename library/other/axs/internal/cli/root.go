...
func newRootCmd(flags *rootFlags) *cobra.Command {
	rootCmd := &cobra.Command{
		Use:   "axs-pp-cli",
		Short: `SRAM AXS CLI for bikes, components, registrations, ride activities, and synced component-summary analytics.`,
		Long: `SRAM AXS CLI for bikes, components, registrations, ride activities, and synced component-summary analytics.

Highlights (cross-bike views the web app doesn't offer):
  • garage   A tree of every bike with its components and serials in one shot.
  • since    New ride activities and notifications since your last sync.
  • shifts   Per-ride front/rear shift counts from synced summaries.
...
Health check: run 'axs-pp-cli doctor' to verify auth and connectivity.
See README.md or the bundled SKILL.md for recipes.`,
		SilenceUsage: true,
		Version:      version,
	}
	rootCmd.SetVersionTemplate("axs-pp-cli {{ .Version }}\n")
	...
	rootCmd.PersistentFlags().StringVar(&flags.profileName, "profile", "", "Apply values from a saved profile (see 'axs-pp-cli profile list')")
	...
	rootCmd.AddCommand(newBikesCmd(flags))
	rootCmd.AddCommand(newComponentsCmd(flags))
	rootCmd.AddCommand(newLinkedidsCmd(flags))
	rootCmd.AddCommand(newSummariesCmd(flags))
	...
	rootCmd.AddCommand(newNovelFirmwareCheckCmd(flags))
	rootCmd.AddCommand(newNovelWearCmd(flags))
	rootCmd.AddCommand(newNovelShiftsCmd(flags))
	rootCmd.AddCommand(newNovelBatteryCmd(flags))
	rootCmd.AddCommand(newNovelGarageCmd(flags))
	rootCmd.AddCommand(newNovelSinceCmd(flags))
	rootCmd.AddCommand(newAPICmd(flags))
	rootCmd.AddCommand(newDevicetypesPromotedCmd(flags))
	...
	rootCmd.AddCommand(newRegistrationsPromotedCmd(flags))
	rootCmd.AddCommand(newStatsPromotedCmd(flags))
	rootCmd.AddCommand(newUnitsPromotedCmd(flags))
