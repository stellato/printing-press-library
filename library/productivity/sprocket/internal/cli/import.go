...
but do not stop the import.`,
  ...
  sprocket-pp-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  sprocket-pp-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | sprocket-pp-cli import <resource> --input -`,
