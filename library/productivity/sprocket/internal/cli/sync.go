...
Resource scoping:
  ...
  sprocket-pp-cli sync

  # Sync specific resources only
  sprocket-pp-cli sync --resources channels,messages

  # Full resync (ignore previous checkpoint)
  sprocket-pp-cli sync --full

  # Incremental sync: only records from the last 7 days
  sprocket-pp-cli sync --since 7d

  # Parallel sync with 8 workers
  sprocket-pp-cli sync --concurrency 8

  # Latest-only: refresh head of each resource, no historical backfill
  sprocket-pp-cli sync --latest-only`,
...
func upsertSingleObject(db *store.Store, resource string, data json.RawMessage) error {
	...
	case "registrations":
		return db.UpsertRegistrations(data)
	case "schedule":
...
func defaultSyncResources() []string {
	return []string{
		"account",
		"account-multiple-clubs",
		"payments",
		"payments-overdue-invoice-payments",
		"payments-overdue-ticket-payments",
		"players",
		"programs",
		"registrations",
		"registrations-completed-team-registrations",
		"teams",
		"teams-player-teams",
	}
}
...
func syncResourcePath(resource string) (string, error) {
	paths := map[string]string{
		"account":                           "/api/account/roles",
		"account-multiple-clubs":            "/api/account/multiple-clubs",
		"payments":                          "/api/club-users/failed-payments",
		"payments-overdue-invoice-payments": "/api/club-users/overdue-invoice-payments",
		"payments-overdue-ticket-payments":  "/api/club-users/overdue-ticket-payments",
		"players":                           "/api/players",
		"programs":                          "/api/public/programs/all",
		"programs-open-programs":            "/api/players/open-programs",
		"registrations":                     "/api/club-users/completed-registrations",
		"registrations-completed-team-registrations": "/api/club-users/completed-team-registrations",
		"schedule":           "/api/public/calendar/calendar-event-types",
		"teams":              "/api/public/teams/all",
		"teams-player-teams": "/api/club-users/player-teams",
	}
