...
and full resync. After archiving, use 'search' for instant full-text search.`,
  ...
  sprocket-pp-cli workflow archive
  ...
  sprocket-pp-cli workflow archive --full`,
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			resources := []string{"account", "account-multiple-clubs", "payments", "payments-overdue-invoice-payments", "payments-overdue-ticket-payments", "players", "programs", "registrations", "registrations-completed-team-registrations", "teams", "teams-player-teams"}
			totalSynced := 0
...
func newWorkflowStatusCmd(flags *rootFlags) *cobra.Command {
  ...
  sprocket-pp-cli workflow status
