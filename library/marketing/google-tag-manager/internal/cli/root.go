...
func newRootCmd(flags *rootFlags) *cobra.Command {
	rootCmd := &cobra.Command{
		Use:   "google-tag-manager-pp-cli",
		Short: `Google Tag Manager CLI — Mirror any GTM container into a local database, then audit, diff, and query it from the terminal — everything the GTM c…`,
		Long: `Google Tag Manager CLI — Mirror any GTM container into a local database, then audit, diff, and query it from the terminal — everything the GTM c…
...
Health check: run 'google-tag-manager-pp-cli doctor' to verify auth and connectivity.
See README.md or the bundled SKILL.md for recipes.`,
		SilenceUsage: true,
		Version:      version,
	}
	rootCmd.SetVersionTemplate("google-tag-manager-pp-cli {{ .Version }}\n")
	...
	rootCmd.PersistentFlags().StringVar(&flags.profileName, "profile", "", "Apply values from a saved profile (see 'google-tag-manager-pp-cli profile list')")
	...
	rootCmd.AddCommand(newTagmanagerCmd(flags))
	...
	rootCmd.AddCommand(newNovelConsentReportCmd(flags))
	rootCmd.AddCommand(newNovelDiffCmd(flags))
	rootCmd.AddCommand(newNovelExportCmd(flags))
	rootCmd.AddCommand(newNovelFiresCmd(flags))
	...
	rootCmd.AddCommand(newNovelUsesCmd(flags))
