...
Resource scoping:
  ...
  equativ-maestro-pp-cli sync

  # Sync specific resources only
  equativ-maestro-pp-cli sync --resources channels,messages

  # Full resync (ignore previous checkpoint)
  equativ-maestro-pp-cli sync --full

  # Incremental sync: only records from the last 7 days
  equativ-maestro-pp-cli sync --since 7d

  # Parallel sync with 8 workers
  equativ-maestro-pp-cli sync --concurrency 8

  # Latest-only: refresh head of each resource, no historical backfill
  equativ-maestro-pp-cli sync --latest-only`,
	...
	cmd.Flags().StringVar(&dbPath, "db", "", "Database path (default: ~/.local/share/equativ-maestro-pp-cli/data.db)")
...
func resourceSupportsPagination(resource string) bool {
	...
	case "report":
		return true
	case "report-dimension-attributes":
		return true
	case "report-dimensions":
		return true
	case "report-troubleshooting":
		return true
	case "self-serve":
		return true
	case "self-serve-advertisers":
		return true
	case "self-serve-campaign-budgets":
		return true
	case "self-serve-campaigns":
		return true
	case "self-serve-creatives":
		return true
	case "self-serve-iab-categories":
		return true
	case "self-serve-line-item-budgets":
		return true
	case "self-serve-lineitems":
		return true
	case "self-serve-native-assets":
		return true
	case "self-serve-tcf-purposes":
		return true
	case "self-serve-tcf-vendors":
		return true
	case "states":
		return true
	}
...
func upsertSingleObject(db *store.Store, resource string, data json.RawMessage) error {
	...
	switch resource {
	case "async-report":
		return db.UpsertAsyncReport(data)
	case "executions":
		return db.UpsertExecutions(data)
	case "async_report_preview":
		return db.UpsertAsyncReportPreview(data)
	case "async-report-gcp":
		return db.UpsertAsyncReportGcp(data)
	case "async_report_gcp_preview":
		return db.UpsertAsyncReportGcpPreview(data)
	case "businessunits":
		return db.UpsertBusinessunits(data)
	case "cities":
		return db.UpsertCities(data)
	case "countries":
		return db.UpsertCountries(data)
	case "deal":
		return db.UpsertDeal(data)
	case "deals":
		return db.UpsertDeals(data)
	case "kpi_trackers":
		return db.UpsertKpiTrackers(data)
	case "dmas":
		return db.UpsertDmas(data)
	case "fields-category":
		return db.UpsertFieldsCategory(data)
	case "inventory-types":
		return db.UpsertInventoryTypes(data)
	case "partners":
	...
	case "self-serve":
		return db.UpsertSelfServe(data)
	case "states":
...
func defaultSyncResources() []string {
	return []string{
		...
		"countries",
		"deals",
		"deals-capping-timeframes",
		"deals-count-breakdown",
		"deals-kpi-trackers-definitions",
		"dmas",
		"fields-category",
		"inventory-types",
		"partners",
		...
		"regions",
		"report",
		"report-campaigns-delivery",
		"report-campaigns-pacing",
		"report-deals-delivery",
		"report-deals-pacing",
		"report-dimension-attributes",
		"report-dimensions",
		"report-field-restriction-rules",
		"report-line-items-delivery",
		"report-line-items-pacing",
...
func knownSyncResourceNames() []string {
	names := []string{
		...
		"self-serve-campaign-budgets",
		"self-serve-campaigns",
		"self-serve-creatives",
		"self-serve-iab-categories",
		"self-serve-line-item-budgets",
		"self-serve-lineitems",
		"self-serve-native-assets",
		"self-serve-tcf-purposes",
		"self-serve-tcf-vendors",
		"states",
	}
...
func syncResourcePath(resource string) (string, error) {
	paths := map[string]string{
		...
		"countries":                      "/countries",
		"deals":                          "/deals",
		"deals-capping-timeframes":       "/deals/cappingTimeframes",
		"deals-count-breakdown":          "/deals/countBreakdown",
		"deals-kpi-trackers-definitions": "/deals/kpiTrackers/definitions",
		"dmas":                           "/dmas",
		...
		"report-campaigns-delivery":      "/report/campaigns/delivery",
		"report-campaigns-pacing":        "/report/campaigns/pacing",
		"report-deals-delivery":          "/report/deals/delivery",
		"report-deals-pacing":            "/report/deals/pacing",
		"report-dimension-attributes":    "/report/dimensionAttributes",
		"report-dimensions":              "/report/dimensions",
		"report-field-restriction-rules": "/report/fieldRestrictionRules",
		"report-line-items-delivery":     "/report/lineItems/delivery",
		"report-line-items-pacing":       "/report/lineItems/pacing",
		"report-troubleshooting":         "/report/troubleshooting",
		"self-serve":                     "/selfServe/trackers",
		"self-serve-advertisers":         "/selfServe/advertisers",
		"self-serve-campaign-budgets":    "/selfServe/campaignBudgets",
		"self-serve-campaigns":           "/selfServe/campaigns",
		"self-serve-creatives":           "/selfServe/creatives",
		"self-serve-iab-categories":      "/selfServe/iabCategories",
		"self-serve-line-item-budgets":   "/selfServe/lineItemBudgets",
		"self-serve-lineitems":           "/selfServe/lineitems",
		"self-serve-native-assets":       "/selfServe/nativeAssets",
		"self-serve-tcf-purposes":        "/selfServe/tcfPurposes",
		"self-serve-tcf-vendors":         "/selfServe/tcfVendors",
		"states":                         "/states",
	}
...
func dependentResourceDefs() []dependentResourceDef {
	return []dependentResourceDef{
		{Name: "async_report_preview", ParentTable: "async-report", ParentIDParam: "id", PathTemplate: "/async-report/{id}/preview", KeyField: "", PathParams: []dependentPathParamDef{
			{Param: "id", Field: "id"},
		}},
	}
}
