...
but do not stop the import.`,
  ...
  equativ-maestro-pp-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  equativ-maestro-pp-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | equativ-maestro-pp-cli import <resource> --input -`,
