...
large datasets as it has no memory pressure.`,
  ...
  equativ-maestro-pp-cli export <resource> --format jsonl --output data.jsonl

  # Export with limit
  equativ-maestro-pp-cli export <resource> --format jsonl --limit 1000

  # Pipe to another tool
  equativ-maestro-pp-cli export <resource> --format jsonl | jq '.id'`,
