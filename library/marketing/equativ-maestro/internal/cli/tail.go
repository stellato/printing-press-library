...
native streaming instead of polling.`,
  ...
  equativ-maestro-pp-cli tail --interval 10s

  # Tail a specific resource
  equativ-maestro-pp-cli tail messages --interval 5s

  # Pipe to jq for filtering
  equativ-maestro-pp-cli tail events --interval 30s | jq 'select(.type == "error")'`,
